...
Extractor::Settlers3::MAPGoods::MAPGoods(Functions::DataReader* reader,unsigned int offset,unsigned int size,unsigned int cryptKey):MAPParts(reader,offset,size,cryptKey,false){
...
std::string Extractor::Settlers3::MAPGoods::HeaderToString(){
