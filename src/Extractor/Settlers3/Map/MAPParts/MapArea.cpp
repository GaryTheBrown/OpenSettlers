...
Extractor::Settlers3::MAPArea::MAPArea(Functions::DataReader* reader,unsigned int offset,unsigned int size,unsigned int cryptKey):MAPParts(reader,offset,size,cryptKey,false){
...
std::string Extractor::Settlers3::MAPArea::HeaderToString(){
