...
bool Extractor::Settlers2::Extract::FullRAWExtract(){
	...
	//Functions::CreateDir(this->saveLocation + "/S2/GFX/");
	//Functions::CreateDir(this->saveLocation + "/S2/SND/");
...
bool Extractor::Settlers2::Extract::RAWLBMFileExtract(std::string *folder, std::string *file){
	if(Functions::FileExists(*folder+*file)){
		...
		Functions::CreateDir(this->saveLocation + "/S2/");
		Functions::CreateDir(this->saveLocation + "/S2/LBM/");
		Functions::CreateDir(this->saveLocation + "/S2/LBM/"+ *file);
		LBMFile->SaveToFile(this->saveLocation + "/S2/LBM/" + *file);
...
bool Extractor::Settlers2::Extract::RAWBBMFileExtract(std::string *folder, std::string *file){
	if(Functions::FileExists(*folder+*file)){
		...
		LOGSYSTEM->Log("Saving...",1);
		Functions::CreateDir(this->saveLocation + "/S2/");
		Functions::CreateDir(this->saveLocation + "/S2/BBM/");
		Functions::CreateDir(this->saveLocation + "/S2/BBM/"+ *file);
		BBMFile->SaveToFile(this->saveLocation + "/S2/BBM/" + *file);
		LOGSYSTEM->Log("Closing...",1);
		delete BBMFile;
		return true;
	}else return false;
...
bool Extractor::Settlers2::Extract::RAWLSTFileExtract(std::string *folder, std::string *file){
	if(Functions::FileExists(*folder+*file)){
		...
		LOGSYSTEM->Log("Saving...",1);
		Functions::CreateDir(this->saveLocation + "/S2/");
		Functions::CreateDir(this->saveLocation + "/S2/LST/");
		Functions::CreateDir(this->saveLocation + "/S2/LST/"+ *file);
		LSTFile->SaveToFile(this->saveLocation + "/S2/LST/" + *file);
		LOGSYSTEM->Log("Closing...",1);
		delete LSTFile;
		return true;
	}else return false;
...
bool Extractor::Settlers2::Extract::RAWIDXFileExtract(std::string *folder, std::string *file){
	if(Functions::FileExists(*folder+*file)){
		...
		LOGSYSTEM->Log("Saving...",1);
		Functions::CreateDir(this->saveLocation + "/S2/");
		Functions::CreateDir(this->saveLocation + "/S2/IDX/");
		Functions::CreateDir(this->saveLocation + "/S2/IDX/"+ *file);
		IDXDATFile->SaveToFile(this->saveLocation + "/S2/IDX/" + *file);
		LOGSYSTEM->Log("Closing...",1);
		delete IDXDATFile;
		return true;
	}else return false;
...
bool Extractor::Settlers2::Extract::RAWBOBFileExtract(std::string *folder, std::string *file){
	if(Functions::FileExists(*folder+*file)){
		...
		LOGSYSTEM->Log("Saving...",1);
		Functions::CreateDir(this->saveLocation + "/S2/");
		Functions::CreateDir(this->saveLocation + "/S2/BOB/");
		Functions::CreateDir(this->saveLocation + "/S2/BOB/"+ *file);
		BOBFile->SaveToFile(this->saveLocation + "/S2/BOB/" + *file);
		LOGSYSTEM->Log("Closing...",1);
		delete BOBFile;
		return true;
	}else return false;
