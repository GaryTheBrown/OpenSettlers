...
void Converter::Settlers3::ConvertGUI::Gold(OSData::GameType* gameType){
	...
	if(Functions::FileExists(originalMenusFile)){
		...
		OSData::GUIButtonData* MMButton1 = new OSData::GUIButtonData(buttonData,"Tutorial",RGBA(0,12,66,255),fontSize,button1,button2,blank,OSData::GUIButtonTypeData(OSData::GUIButtonTypeData::eAction),ReturnData(GMGotoMenu,0),false);
		boxItems->push_back(MMButton1);
		boxItems->push_back(new OSData::GUISpacerData(std::make_pair(0,8)));
		OSData::GUIButtonData* MMButton2 = new OSData::GUIButtonData(buttonData,"Campaign",RGBA(0,12,66,255),fontSize,button1,button2,blank,OSData::GUIButtonTypeData(OSData::GUIButtonTypeData::eAction),ReturnData(GMGotoMenu,2),false);
